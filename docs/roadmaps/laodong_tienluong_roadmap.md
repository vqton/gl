...
- [ ] **Tuần 8:**
  - [ ] Viết test: `LaborReportTests.cs` - tổng hợp số liệu lao động
  - [ ] Triển khai `LaborReportService`:
...
- [ ] **Tuần 9:**
  - [ ] Viết test: `PayrollAccountingIntegrationTests.cs` - hạch toán lương
  - [ ] Tích hợp `PayrollService` với `TransactionService`:
...
- [ ] **Tuần 9:**
  - [ ] Tích hợp với module thuế (đã có từ Phase 2)
  - [ ] Tự động tạo chứng từ khấu trừ thuế TNCN
  - [ ] Tạo file kê khai thuế TNCN định dạng XML

    ...
    public static class ChartOfAccounts
    {
        ...
        public static List<Account> GetAllAccounts()
        {
            return new List<Account>
            {
                ...
                new Account { Code = "133", Name = "Thuế GTGT được khấu trừ", Type = AccountType.Asset, NormalBalance = "Debit" },
                ...
                new Account { Code = "153", Name = "Công cụ, dụng c��", Type = AccountType.Asset, NormalBalance = "Debit" },
                ...
                new Account { Code = "3331", Name = "Thuế GTGT đầu ra", Type = AccountType.Liability, NormalBalance = "Credit" },
                ...
                new Account { Code = "1332", Name = "Thuế GTGT được khấu trừ của TSCĐ", Type = AccountType.Asset, NormalBalance = "Debit" },
